...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        redirect: '/products-manager/products-list', // Chuyển hướng về trang danh sách sản phẩm
        children: [
          {
            path: 'products-list', // path con không bắt đầu bằng '/' để nó là tương đối với cha
            component: () => import('@/views/products-manager/Products.vue'),
          },
          {
          ...
          },
          {
            path: 'button-groups',
            name: 'ButtonGroups',
            component: () => import('@/views/products-manager/ButtonGroups.vue'),
          },
        ],
      },
      {
