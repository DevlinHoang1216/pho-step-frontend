<template>
  <div class="container py-4">
    ...
    <!-- Modal Sua ten san pham (chinh sua thong tin chung cua san pham) -->
...
export default {
  ...
  methods: {
    ...
    async saveEditedProduct() {
      ...
      try {
        // Prepare urlAnhDaiDien for backend:
        // If it's an absolute URL (http/https) or Base64, send it as is.
        // If it's a relative path that was prepended by frontend, remove baseUrl.
        let urlForBackend = this.editingProductImage.trim();
        ...
        const updatedProduct = {
          ...
          urlAnhDaiDien: urlForBackend, // Send the processed URL/Base64
          quocGiaSanXuat: this.editingProductCountry.trim(),
          idDanhMuc: this.editingProductCategoryId,
          idThuongHieu: this.editingProductBrandId,
          idTrangThai: this.editingProductStatusId,
        };
        ...
        this.refreshList(); // Reload main product list
      } catch (error) {
